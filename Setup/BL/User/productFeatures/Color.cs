...
namespace Setup.BL.User.productFeatures
{
    public class Color : IColor
    {
        ...
        public CommonResponse<ColorResponse> GetAllColors(ColorRequest objRequest)
        {
            CommonResponse<ColorResponse> response = new CommonResponse<ColorResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "GetAllColors", ds, TableName, parameters);
