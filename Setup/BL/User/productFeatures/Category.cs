...
namespace Setup.BL.User.productFeatures
{
    public class Category : ICategory
    {
        ...
        {
            CommonResponse<CategoryResponse> response = new CommonResponse<CategoryResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "GetAllCategory", ds, TableName, parameters);
