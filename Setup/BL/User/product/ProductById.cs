...
namespace Setup.BL.User.product
{
    public class ProductById : IProductById
    {
        ...
        public ProductById(IConfiguration configuration)
        {
            _configuration = configuration;
            _dataAccessClass = new DataAccessClass(_configuration);
        }

        public CommonResponse<ProductByIdResponse> GetProductById (ProductByIdRequest objRequest)
        {
            CommonResponse<ProductByIdResponse> response = new CommonResponse<ProductByIdResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "GetProductById", ds, TableName, parameters);
