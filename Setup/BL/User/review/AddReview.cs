...
{
    public class AddReview : IAddReview
    {
        ...
        public CommonResponse<AddReviewResponse> AddProductReview(AddReviewRequest objRequest)
        {
            CommonResponse<AddReviewResponse> response = new CommonResponse<AddReviewResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "AddProductReview", ds, TableName, parameters);
