...
namespace Setup.BL.User.review
{
    public class Testimonial : ITestimonial
    {
        ...
        public Testimonial(IConfiguration configuration)
        {
            _configuration = configuration;
            _dataAccessClass = new DataAccessClass(_configuration);
        }
        public CommonResponse<TestimonialResponse> GetTestimonials(TestimonialRequest objRequest)
        {
            CommonResponse<TestimonialResponse> response = new CommonResponse<TestimonialResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "GetTestimonials", ds, TableName, parameters);
